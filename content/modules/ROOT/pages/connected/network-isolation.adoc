...
Apply preconfigured yamls individually:
...
You can describe the NodeNetworkConfigurationPolicy applied in *worker1*, using:

[source,bash,role=execute]
----
oc describe nncp osp-multi-nic-worker-ocp4-worker1
----
...
Configure the *MetalLB IP address range* using a preconfigured yaml file:
