...
Create instance of *nmstate* resource:
...
Confirm the *metallb* installplan is in the namespace. You may need to retry a few times before the install plan becomes visible:
...
cert-manager-c965b6b46-lbtp7              1/1     Running   0          39m
cert-manager-cainjector-7b97bcbf6-qrbls   1/1     Running   0          49m
cert-manager-webhook-6f8fdf478f-6lgh2     1/1     Running   0          49m
```
